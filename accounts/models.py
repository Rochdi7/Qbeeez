...
from course.models import Program  # Adjust according to your actual app structure
...
LEVEL = (
    # (LEVEL_COURSE, "Level course"),  # Keep this line if needed
    (BACHELOR_DEGREE, _("1er siècle")),  # 1st Century
    (MASTER_DEGREE, _("2ème siècle")),   # 2nd Century
    (MASTER_DEGREE, _("3ème siècle")),    # 3rd Century
)
