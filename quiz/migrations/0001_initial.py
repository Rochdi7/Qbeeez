    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_ru', models.CharField(help_text='Enter the question text that you want displayed', max_length=1000, null=True, verbose_name='Question')),
                ...
                ('explanation_ru', models.TextField(blank=True, help_text='Explanation to be shown after the question has been answered.', max_length=2000, null=True, verbose_name='Explanation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_ru', models.TextField(blank=True, help_text='A detailed description of the quiz', null=True, verbose_name='Description')),
                ...
                ('subcourse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quizzes', to='course.subcourse')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='quiz.question')),
                ('choice_order', models.CharField(blank=True, choices=[('option1', 'Option 1'), ('option2', 'Option 2')], help_text='The order in which multichoice choice options are displayed to the user', max_length=30, null=True, verbose_name='Choice Order')),
                ('year', models.IntegerField(blank=True, null=True)),
                ('question_type', models.CharField(blank=True, choices=[('normales', 'Normales'), ('rattrapage', 'Rattrapage')], max_length=100, null=True)),
                ('correction_type', models.CharField(blank=True, choices=[('O', 'Oui'), ('No', 'Non')], max_length=100, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct_questions', models.CharField(blank=True, max_length=1024, validators=[django.core.validators.RegexValidator(re.compile('^\\d+(?:,\\d+)*\\Z'), code='invalid', message='Enter only digits separated by commas.')], verbose_name='Correct Questions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_en', models.CharField(help_text='Enter the choice text that you want displayed', max_length=1000, null=True, verbose_name='Content')),
                ('choice_fr', models.CharField(help_text='Enter the choice text that you want displayed', max_length=1000, null=True, verbose_name='Content')),
                ('choice_es', models.CharField(help_text='Enter the choice text that you want displayed', max_length=1000, null=True, verbose_name='Content')),
                ('choice_ru', models.CharField(help_text='Enter the choice text that you want displayed', max_length=1000, null=True, verbose_name='Content')),
