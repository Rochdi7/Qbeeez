...
class SupportForm(forms.Form):
    name = forms.CharField(max_length=100, required=True, label="Votre Nom")
    email = forms.EmailField(required=True, label="Votre Email")
    university = forms.CharField(max_length=100, required=True, label="Nom de l'Université")
    university_phone = forms.CharField(max_length=15, required=True, label="Numéro de Téléphone de l'Université")
