...
from .views import *
from .views import course_add    # Import your view function
from .views import StudentProgramListView

urlpatterns = [

    path('programs/', StudentProgramListView.as_view(), name='programs'),
    path('programs/', StudentProgramListView.as_view(), name='program_list'),
    path("<int:program_id>/course/add/", course_add, name="course_add"),  # Use program_id
