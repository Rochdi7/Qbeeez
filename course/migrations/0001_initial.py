    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('bachelor_degree', '1er siècle'), ('master_degree', '2ème siècle'), ('doctorate_degree', '3ème siècle')], max_length=25, null=True)),
                ...
                ('course_type', models.CharField(choices=[('qcm_course', 'QCM par Course'), ('qcm_session', 'QCM par Session')], default='qcm_course', max_length=20)),
            ],
            options={
                'verbose_name': 'Module',
